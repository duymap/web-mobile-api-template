...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "webmobileapi@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "webmobileapi API";

        private String description = "webmobileapi API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "webmobileapi";
